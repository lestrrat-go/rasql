...
For each table it writes a row type with its column-mapping methods, a table type with one field per column, and an accessor returning the table descriptor:
