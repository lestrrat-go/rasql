...
func graphContractPlan(t *testing.T, order bool) (rasql.Executor, rasql.GraphPlan[graphParentRow, graphParent], rasql.GraphPlan[graphChildRow, graphChild], rasql.Query[graphParentRow], rasql.GraphKey[graphParentRow], rasql.GraphKey[graphChildRow]) {
	...
	require.NoError(t, err)
	parentTable := rasql.MustViewOf[graphParentRow](schema.TableDef{Name: "contract_parents", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "tenant", Type: schema.IntegerType{}, Nullable: true}}, PrimaryKey: []string{"id"}})
	childTable := rasql.MustViewOf[graphChildRow](schema.TableDef{Name: "contract_children", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "parent", Type: schema.IntegerType{}}, {Name: "tenant", Type: schema.IntegerType{}}, {Name: "rank", Type: schema.IntegerType{}}}, PrimaryKey: []string{"id"}})
