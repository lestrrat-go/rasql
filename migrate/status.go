...
// It creates the migration-history table when it does not exist. Each
// entry also reports whether that migration can be reverted, so a caller
// can find an irreversible migration before running revert into it.
