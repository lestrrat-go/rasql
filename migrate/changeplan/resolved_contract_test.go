...
func TestOccurrenceIdentityContract(t *testing.T) {
	...
	t.Run("rename ordinary A to B then create A", func(t *testing.T) {
...
func TestOccurrenceReuseSequences(t *testing.T) {
	...
	t.Run("drop ordinary A then recreate A", func(t *testing.T) {
	...
	t.Run("create A drop it then create A", func(t *testing.T) {
