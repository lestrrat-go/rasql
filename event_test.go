...
func TestEventObserverGetsOrderedScopeAndStatementEvents(t *testing.T) {
...
func TestEventObserverErrorsAndPanicsDoNotChangeResults(t *testing.T) {
	executor := sqliteExecutor(t)
...
func TestEventTerminalPreservesStatementError(t *testing.T) {
	executor := sqliteExecutor(t)
...
func TestEventHandlerPanicCannotEscapeExecution(t *testing.T) {
	executor := sqliteExecutor(t)
	var err error
...
func TestEventStatementIndexesAreInvocationLocal(t *testing.T) {
	executor := sqliteExecutor(t)
	var mu sync.Mutex
...
func TestEventRowsCountAndExactlyOnceTerminal(t *testing.T) {
	executor := sqliteExecutor(t)
	var mu sync.Mutex
...
func TestScopeTerminalJoinsCallbackAndRollbackErrors(t *testing.T) {
