...
func TestGoSourceCompilesWithCollidingGeneratedNames(t *testing.T) {
	parsed, err := namedsql.Parse("user_by_values", "SELECT id FROM users WHERE first = {{bind \"statement\"}} OR second = {{bind \"rasqlstatement\"}} OR third = {{bind \"rasqlstatement1\"}}")
	require.NoError(t, err)
	compiled, err := parsed.Compile(dialect.PostgreSQL())
	require.NoError(t, err)
	source, err := querygen.GoSource(compiled.QueryDef(), "generated", "rasqlstatement2")
	require.NoError(t, err)
	requireGeneratedSourceCompiles(t, source)
}
...
func TestGoSourceUntypedBindGoldenBytes(t *testing.T) {
	...
	const want = "// Code generated by rasqlgen; DO NOT EDIT.\n\n" +
		...
		"\treturn rasqlstatement.New(\"SELECT id, email FROM users WHERE email = $1\", email)\n" +
		"}\n"
...
func TestGoSourceTypedBindGoldenBytes(t *testing.T) {
	...
	const want = "// Code generated by rasqlgen; DO NOT EDIT.\n\n" +
		"package time\n\n" +
		"import (\n" +
		"\trasqlstatement \"github.com/lestrrat-go/rasql/statement\"\n" +
		"\ttime1 \"time\"\n" +
		")\n\n" +
		"func WidgetByCreatedAt(createdAt time1.Time) rasqlstatement.Statement {\n" +
		"\treturn rasqlstatement.New(\"SELECT id FROM widgets WHERE created_at = $1\", createdAt)\n" +
		"}\n"
...
// does for the rasqlstatement import.
