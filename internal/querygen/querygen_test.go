...
func TestGoSourceCompilesWithCollidingGeneratedNames(t *testing.T) {
	...
	compiled, err := parsed.Compile(dialect.PostgreSQL())
	require.NoError(t, err)
	source, err := querygen.GoSource(compiled.QueryDef(), "generated", "rasqlrender2")
	require.NoError(t, err)
	requireGeneratedSourceCompiles(t, source)
}
...
func TestGoSourceTypedBindGoldenBytes(t *testing.T) {
	...
	const want = "// Code generated by rasqlgen; DO NOT EDIT.\n\n" +
		"package time\n\n" +
		"import (\n" +
		"\trasqlrender \"github.com/lestrrat-go/rasql/render\"\n" +
		"\ttime1 \"time\"\n" +
		")\n\n" +
		"func WidgetByCreatedAt(createdAt time1.Time) (rasqlrender.Statement, error) {\n" +
		"\treturn rasqlrender.Precompiled(\"SELECT id FROM widgets WHERE created_at = $1\", createdAt)\n" +
		"}\n"
