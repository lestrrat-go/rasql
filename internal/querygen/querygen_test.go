...
func TestGoSourceCompilesWithCollidingGeneratedNames(t *testing.T) {
	parsed, err := namedsql.Parse("user_by_values", "SELECT id FROM users WHERE first = {{bind \"stmt\"}} OR second = {{bind \"rasqlstmt\"}} OR third = {{bind \"rasqlstmt1\"}}")
	require.NoError(t, err)
	compiled, err := parsed.Compile(dialect.PostgreSQL())
	require.NoError(t, err)
	source, err := querygen.GoSource(compiled.QueryDef(), "generated", "rasqlstmt2")
	require.NoError(t, err)
	requireGeneratedSourceCompiles(t, source)
}
...
func TestGoSourceUntypedBindGoldenBytes(t *testing.T) {
	...
	const want = "// Code generated by rasqlgen; DO NOT EDIT.\n\n" +
		...
		"\treturn rasqlstmt.New(\"SELECT id, email FROM users WHERE email = $1\", email)\n" +
		"}\n"
...
func TestGoSourceTypedBindGoldenBytes(t *testing.T) {
	...
	const want = "// Code generated by rasqlgen; DO NOT EDIT.\n\n" +
		"package time\n\n" +
		"import (\n" +
		"\trasqlstmt \"github.com/lestrrat-go/rasql/stmt\"\n" +
		"\ttime1 \"time\"\n" +
		")\n\n" +
		"func WidgetByCreatedAt(createdAt time1.Time) rasqlstmt.Statement {\n" +
		"\treturn rasqlstmt.New(\"SELECT id FROM widgets WHERE created_at = $1\", createdAt)\n" +
		"}\n"
