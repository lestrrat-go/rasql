...
// exercises.
//
// This is a plain-text substring check, not a YAML parse: both ci.yml's
...
func TestCIWorkflowDSNsMatchComposeConstants(t *testing.T) {
	...
	require.True(t, strings.Contains(compose, wantPGUser),
	...
	require.True(t, strings.Contains(compose, wantPGPassword),
	...
	require.True(t, strings.Contains(compose, wantPGDatabase),
	...
	require.True(t, strings.Contains(compose, wantPGPort),
	...
	require.True(t, strings.Contains(compose, wantMySQLDatabase),
	...
	require.True(t, strings.Contains(compose, wantMySQLPort),
	...
	require.True(t, strings.Contains(compose, wantMySQLPassword),
