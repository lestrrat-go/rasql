...
func rasqlNullableReport(ctx context.Context, executor rasql.Executor, _ rasql.DB, _ string) (parityEvidence, error) {
	...
	optionalMembers, err := rasql.ViewOf[optionalMemberRow](schema.TableDef{Name: "members", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "name", Type: schema.TextType{}, Nullable: true}}})
	if err != nil {
		return parityEvidence{}, err
	}
