...
var tasksDefinition = schema.TableDef{
	...
	Columns: []schema.ColumnDef{
		...
		{Name: "title", Type: schema.TextType{}, NativeType: &schema.NativeTypeDef{Dialect: "sqlite", Name: "VARCHAR", Kind: schema.NativeTypeKind("other"), Arguments: []string{"128"}}},
		{Name: "is_open", Type: schema.BooleanType{}, Default: "TRUE", NativeType: &schema.NativeTypeDef{Dialect: "sqlite", Name: "BOOLEAN", Kind: schema.NativeTypeKind("other")}},
		{Name: "due_on", Type: schema.TimeType{}, Nullable: true, NativeType: &schema.NativeTypeDef{Dialect: "sqlite", Name: "DATE", Kind: schema.NativeTypeKind("other")}},
		{Name: "created_at", Type: schema.TimeType{}, Default: "'2024-01-01T00:00:00Z'"},
	},
