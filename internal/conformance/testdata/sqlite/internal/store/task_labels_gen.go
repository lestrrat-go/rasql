...
var task_labelsDefinition = schema.TableDef{
	...
	ForeignKeys: []schema.ForeignKeyDef{
		{Columns: []string{"task_id"}, ReferencedTable: "tasks", ReferencedColumns: []string{"id"}, OnDelete: schema.NoAction, OnUpdate: schema.NoAction},
	},
}
...
var task_labelsResultColumns = []rasql.ResultColumn{
	...
	{Name: "label", Type: schema.TextType{}, Codec: ""},
}
...
func Task_labelsProjection(source Task_labelsTable) (rasql.Projection[Task_labelsRow], error) {
	items := []rasql.ProjectionItem{
		...
		rasql.Item("label", source.Task_labelsExpressions.Label.Expr(), schema.TextType{}, ""),
	}
