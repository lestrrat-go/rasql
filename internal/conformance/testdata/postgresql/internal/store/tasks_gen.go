...
var tasksDefinition = schema.TableDef{
	...
	Columns: []schema.ColumnDef{
		...
		{Name: "created_at", Type: schema.TimeType{}, Default: "'2024-01-01 00:00:00'::timestamp without time zone", NativeType: &schema.NativeTypeDef{Dialect: "postgresql", Schema: "pg_catalog", Name: "timestamp", Kind: schema.NativeTypeKind("builtin"), Arguments: []string{"6"}}},
	},
	...
	ForeignKeys: []schema.ForeignKeyDef{
		...
		{Name: "tasks_project_id_fkey", Columns: []string{"project_id"}, ReferencedTable: "projects", ReferencedColumns: []string{"id"}, OnDelete: schema.NoAction, OnUpdate: schema.NoAction},
	},
}
