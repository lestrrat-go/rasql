...
func TestGenerationNamesAndDigestOperationsAreValidated(t *testing.T) {
	...
	require.Error(t, err)
	f := compilerlock.File{Format: compilerlock.FormatVersion, Compiler: "x", Source: compilerlock.SourceRecord{Kind: "live", Identity: "x"}, Engine: compilerlock.EngineRecord{Dialect: "sqlite", Profile: "sqlite-3"}, Catalog: compilerlock.CatalogRecord{Objects: []compilerlock.ObjectRecord{}}, Generation: compilerlock.GenerationRecord{Package: "p", Output: "out", Emitter: "compact", Objects: []compilerlock.ObjectNameRecord{}}, Digests: compilerlock.Digests{Source: h, Mappings: h, Queries: h, Generation: h}}
