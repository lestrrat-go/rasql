...
func TestR5PostgreSQLPagesMatchEveryExplicitNullOrder(t *testing.T) {
...
func TestR5MySQLExplicitNullOrderRefusesBeforeHandle(t *testing.T) {
...
func TestR5AutocommitMutationDiffersFromExplicitTransaction(t *testing.T) {
	database := dbtest.PostgreSQLDB(t)
