...
func pageFixture(t *testing.T) (rasql.Executor, rasql.Query[pageParentRow], rasql.GraphKey[pageParentRow], rasql.GraphKey[pageTaskRow], rasql.GraphKey[pageTaskRow], rasql.GraphKey[pageTaskRow], rasql.GraphKey[pageAssigneeRow], rasql.GraphKey[pageLabelRow], rasql.GraphKey[pageJunctionRow], rasql.GraphKey[pageJunctionRow], rasql.Source, rasql.GraphPlan[pageTaskRow, pageTaskGraph], rasql.GraphPlan[pageAssigneeRow, pageAssigneeGraph], rasql.GraphPlan[pageLabelRow, pageLabelGraph]) {
	...
	require.NoError(t, err)
	parentTable := rasql.MustViewOf[pageParentRow](schema.TableDef{Name: "page_parents", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}}, PrimaryKey: []string{"id"}})
	taskTable := rasql.MustViewOf[pageTaskRow](schema.TableDef{Name: "page_tasks", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "parent", Type: schema.IntegerType{}}, {Name: "assignee", Type: schema.IntegerType{}}}, PrimaryKey: []string{"id"}})
	assigneeTable := rasql.MustViewOf[pageAssigneeRow](schema.TableDef{Name: "page_assignees", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "name", Type: schema.TextType{}}}, PrimaryKey: []string{"id"}})
	labelTable := rasql.MustViewOf[pageLabelRow](schema.TableDef{Name: "page_labels", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "name", Type: schema.TextType{}}}, PrimaryKey: []string{"id"}})
	junctionTable := rasql.MustViewOf[pageJunctionRow](schema.TableDef{Name: "page_task_labels", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "task", Type: schema.IntegerType{}}, {Name: "label", Type: schema.IntegerType{}}, {Name: "rank", Type: schema.IntegerType{}}}, PrimaryKey: []string{"id"}})
