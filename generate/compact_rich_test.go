...
func TestRichCompactRuntime(t *testing.T) {
 ...
 db, err := rasql.Open(ctx, sqlDB, dialect.SQLite()); if err != nil { t.Fatal(err) }
 executor := rasql.Executor(db)
