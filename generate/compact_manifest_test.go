...
func compactTopLevelDeclarationsFromSource(t *testing.T, source []byte) []string {
	...
	for _, declaration := range file.Decls {
		...
		case *ast.FuncDecl:
			...
			result = append(result, compactReceiverName(declaration.Recv)+"."+declaration.Name.Name)
		case *ast.GenDecl:
