...
func bindingTables() (schema.TableDef, schema.TableDef, schema.TableDef) {
	...
	bad := schema.TableDef{Name: "bad_values", Columns: []schema.ColumnDef{{Name: "id", Type: schema.IntegerType{}}, {Name: "value", Type: schema.TextType{}, GoBinding: &schema.GoBinding{Type: "NoScan", NullableType: "NoScan"}}}}
