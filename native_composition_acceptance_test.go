...
func TestNativeDerivedAndCTESQLiteExecutionPreservesArgumentOrderAndCodecCounts(t *testing.T) {
...
func TestNativeDerivedClonesRetainAdoptedSnapshot(t *testing.T) {
	calls := &atomic.Int64{}
