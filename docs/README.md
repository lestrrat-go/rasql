...
2. [The generated store](orm/02-generated-store.md) says what that package contains: row types, table types, their column fields, projections, and static query functions.
