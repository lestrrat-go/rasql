...
func TestCompactTypedQueryPlanOwnsExistingFiles(t *testing.T) {
	...
	// A stray marker-carrying file the offline check cannot see: without a database it never
	// rebuilds a plan to compare ownership against, so orphan detection is a generate/check -dsn
	// guarantee only. generate -scratch still prunes it, proven below.
